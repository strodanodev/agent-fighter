...
--
-- Replaces 0011's 3-arg create_agent_account. Auth gate is in server.ts;
-- this RPC refuses empty / agent-class owners.
...
drop function if exists create_agent_account(text, text, text);
